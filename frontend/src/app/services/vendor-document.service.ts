...
getVendorDocuments(vendorId: number): Observable<any[]> {
  ...
  approveVendorDocument(documentId: number): Observable<any> {
    return this.http.put<any>(`${this.baseUrl}/vendor-documents/${documentId}/approve`, {}, {
      headers: this.getAuthHeaders()
    });
  }

  rejectVendorDocument(documentId: number): Observable<any> {
    return this.http.put<any>(`${this.baseUrl}/vendor-documents/${documentId}/reject`, {}, {
      headers: this.getAuthHeaders()
    });
  }
}
